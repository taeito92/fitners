        ...
        <div class="row">
            <div class="col-md-10" style="margin: auto">
                <div class="card card-primary">
                    ...
                    <!-- form start -->
                    <form id="galleryRegister" action="/gallery/register" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="galleryTitle">제목</label>
                                <input type="text" name="title" class="form-control col-5" placeholder="제목을 입력하세요..." id="galleryTitle">
                            </div>
                            <div>
                                <label for="galleryWriter">작성자</label>
                                <input type="text" name="writer" class="form-control col-5" placeholder="작성자를 입력하세요..." id="galleryWriter">
                            </div>
                            <div>
                    ...
                    <div style="margin-left: 15px">
                        <label for="galleryAttach">파일 첨부</label>
                        <span class="input-group" id="galleryAttach">
...
<script>
   ...
   document.querySelector("#submitBtn").addEventListener("click", (e) => {
       ...
       const galleryRegister = document.querySelector("#galleryRegister")

       //첨부파일 없는 경우
       if (!fileDivArr) {
           galleryRegister.submit()
           return
       }
